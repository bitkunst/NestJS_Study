...
export class UserEntity extends CommonEntity {
  ...
  @OneToOne(() => ProfileEntity) // 단방향 연결, 양방향도 가능 (양방향을 하기 위해서는 ProfileEntity에서 추가 설정 필요)
  @JoinColumn({ name: 'profile_id', referencedColumnName: 'id' }) // DB 컬럼 이름 : profile_id , referenceColumnName : ProfileEntity의 id 컬럼 참조
